...
SELECT AddGeometryColumn('bike_network_merge','geom',32126,'MULTILINESTRING','XY'); 
...
SELECT AddGeometryColumn('bike_network_merge_dissolve','geom',32126,'LINESTRING','XY');
...
SELECT AddGeometryColumn('bike_network_merge_points','geom_point',32126,'POINT','XY');
SELECT AddGeometryColumn('bike_network_merge_points','geom_point_buffer_2m',32126,'POLYGON','XY'); 
SELECT AddGeometryColumn('bike_network_merge_points','geom_point_buffer_5m',32126,'POLYGON','XY');
...
SELECT RecoverGeometryColumn('bike_network_merge_dissolve_within_2m', 'geom_point', 32126, 'POINT', 'XY');
...
SELECT RecoverGeometryColumn('bike_network_merge_dissolve_within_5m', 'geom_point', 32126, 'POINT', 'XY');
