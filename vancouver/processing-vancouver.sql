...
SELECT AddGeometryColumn('bike_network_merge','geom',32148,'MULTILINESTRING','XY'); 
...
SELECT AddGeometryColumn('bike_network_merge_dissolve','geom',32148,'LINESTRING','XY');
...
SELECT AddGeometryColumn('bike_network_merge_points','geom_point',32148,'POINT','XY');
SELECT AddGeometryColumn('bike_network_merge_points','geom_point_buffer_2m',32148,'POLYGON','XY'); 
SELECT AddGeometryColumn('bike_network_merge_points','geom_point_buffer_5m',32148,'POLYGON','XY');
...
SELECT RecoverGeometryColumn('bike_network_merge_dissolve_within_2m', 'geom_point', 32148, 'POINT', 'XY');
...
SELECT RecoverGeometryColumn('bike_network_merge_dissolve_within_5m', 'geom_point', 32148, 'POINT', 'XY');
